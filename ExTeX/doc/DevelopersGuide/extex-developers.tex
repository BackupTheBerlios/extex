%%*****************************************************************************
%% $Id: extex-developers.tex,v 1.3 2005/08/30 08:02:59 gene Exp $
%%*****************************************************************************
...
\begin{figure}[htp]
  ...
  \hfill
  \subfigure[Selecting to check-out of \ExTeX\label{fig:eclipse-checkout-extex}]{%
...
\INCOMPLETE Eclipse shows a progress bar during the check-out (see
...
finished you will find the project \texttt{ExTeX} in Eclipse containing
the files within. The appearance of the Package View with those files
is shown in figure~\ref{fig:eclipse-extex-project}.
\begin{figure}[htp]
  \hbox{}\hfill
...
\File{ExTeX-setup.jar} in the director \File{target}. The use of the
