%%*****************************************************************************
%% $Id: extex-users.tex,v 1.4 2005/05/31 06:28:27 gene Exp $
%%*****************************************************************************
...
%\maketitle
  ...
  \unitlength=1mm
  \begin{picture}(0,0)
    \put(56,116){\makebox(0,0){\scalebox{6}{\rotatebox{45}{\textsf{\Huge\bfseries Draft}}}}}
  \end{picture}
  \end{center}
\newpage
\footnotesize
...
installation. Especially the value of \Property{extex.texinputs} most
