%%*****************************************************************************
%% $Id: extex-users.tex,v 1.12 2005/06/03 06:04:50 gene Exp $
%%*****************************************************************************
...
current directory. The settings in the current directoy overwrite the
...
%------------------------------------------------------------------------------
\chapter{The Macro Langauge of \ExTeX}
%@author Gerd Neugebauer
