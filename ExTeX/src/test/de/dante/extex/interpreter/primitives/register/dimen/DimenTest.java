...
public class DimenTest extends ExTeXLauncher {
    ...
    public void testError3() throws Exception {
        ...
        runCode(//--- input code ---
                "\\dimen1=\\dimen 6pt/0\\relax" + "\\the\\dimen1 ",
                //--- log message ---
                "Arithmetic overflow",
                //--- output channel ---
                "");
    ...
    public void test1() throws Exception {
        ...
        runCode(//--- input code ---
                "\\dimen1=\\dimen 1pt + 2pt\\relax" + "\\the\\dimen1 ",
                //--- log message ---
                "",
                //--- output channel ---
                "3.0pt \n\n");
    ...
    public void test2() throws Exception {
        ...
        runCode(//--- input code ---
                "\\dimen1=\\dimen 2*3pt\\relax" + "\\the\\dimen1 ",
                //--- log message ---
                "",
                //--- output channel ---
                "6.0pt \n\n");
    ...
    public void test3() throws Exception {
        ...
        runCode(//--- input code ---
                "\\dimen1=\\dimen 5pt-2pt\\relax" + "\\the\\dimen1 ",
                //--- log message ---
                "",
                //--- output channel ---
                "3.0pt \n\n");
    ...
    public void test4() throws Exception {
        ...
        runCode(//--- input code ---
                "\\dimen1=\\dimen 6pt/2\\relax" + "\\the\\dimen1 ",
                //--- log message ---
                "",
                //--- output channel ---
                "3.0pt \n\n");
    ...
    public void test10() throws Exception {
        ...
        runCode(//--- input code ---
                "\\dimen1=\\dimen 1pt + 2*3pt\\relax" + "\\the\\dimen1 ",
                //--- log message ---
                "",
                //--- output channel ---
                "7.0pt \n\n");
    ...
    public void test11() throws Exception {
        ...
        runCode(//--- input code ---
                "\\dimen1=\\dimen 2pt*3 + 1pt\\relax" + "\\the\\dimen1 ",
                //--- log message ---
                "",
                //--- output channel ---
                "7.0pt \n\n");
    ...
    public void test12() throws Exception {
        ...
        runCode(//--- input code ---
                "\\dimen1=\\dimen 4pt/2 + 10pt\\relax" + "\\the\\dimen1 ",
                //--- log message ---
                "",
                //--- output channel ---
                "12.0pt \n\n");
    ...
    public void test13() throws Exception {
        ...
        runCode(//--- input code ---
                "\\dimen1=\\dimen 10pt + 4pt/2\\relax" + "\\the\\dimen1 ",
                //--- log message ---
                "",
                //--- output channel ---
                "12.0pt \n\n");
    ...
    public void test14() throws Exception {
        ...
        runCode(//--- input code ---
                "\\dimen1=\\dimen 1pt - 2pt*3\\relax" + "\\the\\dimen1 ",
                //--- log message ---
                "",
                //--- output channel ---
                "-5.0pt \n\n");
    ...
    public void test21() throws Exception {
        ...
        runCode(//--- input code ---
                "\\dimen1=\\dimen 2*(1pt + 2pt)\\relax" + "\\the\\dimen1 ",
                //--- log message ---
                "",
                //--- output channel ---
                "6.0pt \n\n");
    ...
    public void test33() throws Exception {
        ...
        runCode(//--- input code ---
                "\\dimen1=\\dimen -2pt + 3pt\\relax" + "\\the\\dimen1 ",
                //--- log message ---
                "",
                //--- output channel ---
                "1.0pt \n\n");
