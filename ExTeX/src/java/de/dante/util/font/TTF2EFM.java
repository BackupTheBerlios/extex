...
import de.dante.extex.font.TTFException;
...
public class TTF2EFM {
	...
	public static void main(String[] args) throws TTFException, IOException {

		if (args.length != 2) {
			System.err.println("java de.dante.util.font.TTF2EFM <ttf-file> <efm-file>");
			System.exit(1);
		}
