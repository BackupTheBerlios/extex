 ...
 */
public class TtfTableVHEA extends AbstractXtfTable
        implements
            XtfTable,
            XMLConvertible {
     ...
     */
    TtfTableVHEA(final XtfTableMap tablemap, final XtfTableDirectory.Entry de,
    ...
    public Element toXML() {
        ...
        Element table = new Element("vhea");
