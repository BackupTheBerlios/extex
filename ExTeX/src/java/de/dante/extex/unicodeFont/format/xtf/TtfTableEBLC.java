 ...
 */
public class TtfTableEBLC extends AbstractXtfTable
        implements
            XtfTable,
            XMLConvertible {
     ...
     */
    TtfTableEBLC(final XtfTableMap tablemap, final XtfTableDirectory.Entry de,
    ...
    public Element toXML() {
        ...
        Element table = new Element("eblc");
