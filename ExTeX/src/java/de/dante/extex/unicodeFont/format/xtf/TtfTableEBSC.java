 ...
 */
public class TtfTableEBSC extends AbstractXtfTable
        implements
            XtfTable,
            XMLConvertible {
     ...
     */
    TtfTableEBSC(final XtfTableMap tablemap, final XtfTableDirectory.Entry de,
    ...
    public Element toXML() {
        ...
        Element table = new Element("ebsc");
