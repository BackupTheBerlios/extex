...
public class TtfTablePOST extends AbstractXtfTable
    ...
    public void writeXML(final XMLStreamWriter writer) throws IOException {
        ...
        writer.writeAttribute("maxmemtype1", String.valueOf(maxMemType1));
        writer.writeAttribute("maxmemtype42", String.valueOf(maxMemType42));
        writer.writeAttribute("minmemtype1", String.valueOf(minMemType1));
