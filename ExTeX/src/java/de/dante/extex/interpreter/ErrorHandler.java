...
public interface ErrorHandler {
	 ...
	 * 
	 * @param e
	 *                 the exception which has led to the invokation
	 * @param source
	 *                 the token source
	 * @param context
	 ...
	 */
	public abstract boolean handleError(GeneralException e, Token t, TokenSource source, Context context) throws GeneralException;
}
