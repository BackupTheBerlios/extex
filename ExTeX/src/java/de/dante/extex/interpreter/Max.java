...
public class Max extends Moritz implements CatcodeVisitor,
                                           ...
                                           TokenSource,
                                           Observable {
    /** This calender instance contains the time and date when ExTeX
     *  has been started.
     */
    private Calendar calendar = Calendar.getInstance();

    /** This is the processing context. Here nearly all relevant information
     *  can be found.
     */
     ...
     *  argument is the exception encountered.
     */
    private ObserverList observersError = new ObserverList();

    /** This observer list is used for the observers which are registered
     *  to receive a notification when a new token is about to be expanded.
     *  The argument is the token to be expanded.
     */
     ...
     *  <tr><td>expand</td><td></td></tr>
     *  <tr><td>pop   </td><td>inherited from the super class</td></tr>
     *  <tr><td>push  </td><td>inherited from the super class</td></tr>
     *  <tr><td>EOF   </td><td>inherited from the super class</td></tr>
     * </table>
     *
     ...
     * {@link #visitActive(java.lang.Object,java.lang.Object) visitActive}
    ...
    /**
     * A comment is ignored. This should never happen since comments are
     * eaten up in the scanner already.
    ...
    public Object visitMacroParam(Object oToken, Object ignore)
                           throws GeneralException {
        throw new GeneralHelpingException("TTP.CantUseIn",
     ...
     * ...
     *
     * @param token the token which is about to be expended (for error
     * reporting purposes)
     * @param code the definition to expand
     *
     * @return <code>null</code>
     */
    private Object execute(Token token, Code code)
                    throws GeneralException {
        if (code == null) {
