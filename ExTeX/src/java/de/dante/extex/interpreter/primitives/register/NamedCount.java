 ...
 */
public class NamedCount extends AbstractCode implements Advanceable, Multiplyable, Divideable, CountConvertable {
	/**
	...
	public Tokens getThe(Context context, TokenSource source) throws GeneralException {
		Tokens toks = new Tokens(context, context.getCount(getName()).toString());
		return toks;
	}
	 ...
	 *                 ...
	 */
	protected void advance(Flags prefix, Context context, TokenSource source, String key) throws GeneralException {
	...
	protected void multiply(Flags prefix, Context context, TokenSource source, String key) throws GeneralException {
		source.scanKeyword("by");
	...
	protected void divide(Flags prefix, Context context, TokenSource source, String key) throws GeneralException {
		source.scanKeyword("by");
	 ...
	 * @return ...
	 */
	protected long convertCount(Context context, TokenSource source, String key) {
	 ...
	 *                 ...
	 */
	protected long scanCount(Context context, TokenSource source) throws GeneralException {
