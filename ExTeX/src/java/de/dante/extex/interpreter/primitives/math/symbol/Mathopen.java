 ...
 * <p>
 *  The primitive <tt>\mathopen</tt> takes an argument and treats it as
 *  an opening symbol. It works in math mode only. The argument can either
 ...
 *  <pre class="syntax">
 *    &lang;mathopen&rang;
 *       &rarr; <tt>\mathopen</tt> &lang;formula&rang;
 *
 *    &lang;formula&rang;
