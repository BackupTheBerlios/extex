...
/**
 * This class provides an implementation for the primitive <code>\displaystyle</code>.
 *
 ...
 */
public class Displaystyle extends AbstractCode {
     ...
     */
    public Displaystyle(final String name) {
