...
package de.dante.extex.interpreter.context.observer.glue;
...
public interface GlueObservable {
     ...
     * Count change events are triggered when a value is assigned to a glue
     ...
     */
    void registerGlueObserver(String name, GlueObserver observer);
     ...
     * @param observer the observer to receive the events
     */
    void unregisterGlueObserver(String name, GlueObserver observer);
