...
public class ErrorHandlerImpl implements ErrorHandler {
	 ...
	 */
	public boolean handleError(final GeneralException exception, final Token t, final TokenSource source, final Context context)
			...
			for (;;) {
				...
				if (line.equals("")) {
					...
					switch (line.charAt(0)) {
						...
						case 'i' :
						case 'I' :
							source.addStream(source.getTokenStreamFactory().newInstance(line.substring(1), "ISO-8859-1"));
