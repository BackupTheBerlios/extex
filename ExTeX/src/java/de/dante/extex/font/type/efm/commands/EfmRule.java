...
public class EfmRule implements Serializable, EfmHVW {
     ...
     */
    public EfmRule(final Element element, final Dimen designsize)
        ...
        try {
            ...
            height = new Dimen((long) (designsize.getValue()
                    * attr.getDoubleValue() * VFFont.UNITS_PER_EM_DEFAULT));
