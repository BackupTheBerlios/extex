...
public class LookupList {
     ...
     */
    LookupList(final RandomAccessR rar, final int offset) throws IOException {
        ...
        for (int i = 0; i < lookupCount; i++) {
            lookups[i] = new Lookup(rar, offset + lookupOffsets[i]);
        }
    }
     ...
     */
    public Lookup getLookup(final FeatureList.Feature feature, final int index) {
