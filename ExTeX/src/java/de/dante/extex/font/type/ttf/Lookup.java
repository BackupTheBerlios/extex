...
public class Lookup {
     ...
     */
    Lookup(final RandomAccessR rar, final int offset) throws IOException {
        ...
        subTables = new LookupTable[subTableCount];
     ...
     * @throws IOException if an IO-error occurs
     */
    public LookupTable newInstance(final int tabletype, final RandomAccessR rar,
            final int offset) throws IOException {

        LookupTable s = null;
        switch (tabletype) {
            case SINGLE :
                s = SingleTable.newInstance(rar, offset);
                break;
            case MULTIPLE :
                break;
            case ALTERNATE :
                break;
            case LIGATURE :
                s = LigatureTable.newInstance(rar, offset);
                break;
            case CONTEXT :
                break;
            case CHAINING :
     ...
     * @return  Returns the subtable
     */
    public LookupTable getSubtable(final int i) {
