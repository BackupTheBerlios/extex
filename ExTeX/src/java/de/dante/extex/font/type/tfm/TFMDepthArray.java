 ...
 *
 * <p>width : array [0 .. (nd-1)] of fix word</p>
 *
 * <p>
 * Information from:
...
public class TFMDepthArray implements XMLConvertible, Serializable {
    ...
    public Element toXML() {
        ...
        Element element = new Element("depthtable");
        for (int i = 0; i < table.length; i++) {
            Element e = new Element("depth");
