 ...
 */
public abstract class LigatureTable extends LookupTable {
     ...
     */
    LigatureTable(final int format) {
     ...
     */
    static LigatureTable newInstance(final RandomAccessR rar, final int offset)
            throws IOException {

        LigatureTable ls = null;
        rar.seek(offset);
     ...
     * Table for format1
     */
    public static class LigatureTableFormat1 extends LigatureTable {
