 ...
 */
public class TokenStreamStringImpl extends AbstractTokenStreamImpl implements TokenStream, CatcodeVisitor {
     ...
     */
    public TokenStreamStringImpl(final String line) {
        super();
        if (line != null) {
        	this.line = line;
        } else {
