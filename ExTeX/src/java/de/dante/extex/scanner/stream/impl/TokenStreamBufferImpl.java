...
public class TokenStreamBufferImpl extends TokenStreamBaseImpl
     ...
     */
    public TokenStreamBufferImpl(String line)
    ...
    public TokenStreamBufferImpl(String line, String encoding)
                          throws CharacterCodingException {
        super();
        buffer = Charset.forName(encoding)
                        .newDecoder()
    ...
    public Token getNext(TokenFactory factory, Tokenizer tokenizer) throws GeneralException {
        ...
        do {
            ...
            t = (Token) tokenizer.getCatcode(buffer.get(pointer))
                                 .visit(this, factory, tokenizer);
        } while (t == null);
    ...
    public Object visitComment(Object oFactory, Object oTokenizer) throws GeneralException {
        ...
        while (advancePointer() &&
                   tokenizer.getCatcode(buffer.get(pointer)) != Catcode.CR) {
        }

        while (advancePointer() &&
                   tokenizer.getCatcode(buffer.get(pointer)) == Catcode.SPACE) {
        }
    ...
    public Object visitEscape(Object oFactory, Object oTokenizer) throws GeneralException {
        ...
        if (advancePointer()) {
            ...
            while (!advancePointer() &&
                       tokenizer.getCatcode(buffer.get(pointer)) == Catcode.LETTER) {
                sb.append(buffer.get(pointer));
            }
            ...
            return factory.newInstance(Catcode.ESCAPE,
                                       Character.toString(buffer.get(pointer++)));
        }
    }
    ...
    public Object visitLeftBrace(Object oFactory, Object oTokenizer) throws GeneralException {
        Token token = ((TokenFactory) oFactory).newInstance(Catcode.LEFTBRACE,
                                                            buffer.get(pointer));
        advancePointer();
        return token;
    }
    ...
    public Object visitLetter(Object oFactory, Object oTokenizer) throws GeneralException {
        Token token = ((TokenFactory) oFactory).newInstance(Catcode.LETTER,
                                                            buffer.get(pointer));
        advancePointer();
        return token;
    }
    ...
    public Object visitMacroParam(Object oFactory, Object oTokenizer) throws GeneralException {
        Token token = ((TokenFactory) oFactory).newInstance(Catcode.MACPARAM,
                                                            buffer.get(pointer));
        advancePointer();
        return token;
    }
    ...
    public Object visitMathShift(Object oFactory, Object oTokenizer) throws GeneralException {
        Token token = ((TokenFactory) oFactory).newInstance(Catcode.MATHSHIFT,
                                                            buffer.get(pointer));
        advancePointer();
        return token;
    }
    ...
    public Object visitOther(Object oFactory, Object oTokenizer) throws GeneralException {
        Token token = ((TokenFactory) oFactory).newInstance(Catcode.OTHER,
                                                            buffer.get(pointer));
        advancePointer();
        return token;
    }
    ...
    public Object visitRightBrace(Object oFactory, Object oTokenizer) throws GeneralException {
        Token token = ((TokenFactory) oFactory).newInstance(Catcode.RIGTHBRACE,
                                                            buffer.get(pointer));
        advancePointer();
        return token;
    }
    ...
    public Object visitSpace(Object oFactory, Object oTokenizer) throws GeneralException {
        ...
        return factory.newInstance(Catcode.SPACE, sb.toString());
    }
    ...
    public Object visitSubMark(Object oFactory, Object oTokenizer) throws GeneralException {
        Token token = ((TokenFactory) oFactory).newInstance(Catcode.SUBMARK,
                                                            buffer.get(pointer));
        advancePointer();
        return token;
    }
    ...
    public Object visitSupMark(Object oFactory, Object oTokenizer) throws GeneralException {
        ...
        if (hc1 < 0 || !advancePointer()) {
            ...
            return tokenizer.getCatcode((char) hc1)
                            .visit(this, oFactory, oTokenizer);
        }
        ...
        return tokenizer.getCatcode(buffer.get(pointer))
                        .visit(this, oFactory, oTokenizer);
    ...
    public Object visitTabMark(Object oFactory, Object oTokenizer) throws GeneralException {
        Token token = ((TokenFactory) oFactory).newInstance(Catcode.TABMARK,
                                                            buffer.get(pointer));
        advancePointer();
        return token;
    }
     ...
     * This method is meant to be used for the look-ahead to determine the
     * format to be used. For this purpose this method has to be used
