...
// * <p>
// * In addition this class provides an engine to tokenize the input stream 
// * (use 32 bit for a character) and refill the buffer at its end.
// * </p>
// *
// * @author <a href="mailto:m.g.n@gmx.de">Michael Niedermair</a>
// * @version $Revision: 1.2 $
// */
//public class TokenStreamBufferImpl32 extends TokenStreamBaseImpl implements TokenStream, CatcodeVisitor {
//
//    /**
//     * new line
//     */
...
//     */
//    protected TokenStreamBufferImpl32() {
//        super();
...
//     * TODO is String line the correct way? must this 
//     *
...
//     */
//    public TokenStreamBufferImpl32(final String line, final String encoding)
//            throws CharacterCodingException {
//
//        super();
//        CharBuffer cb = Charset.forName(encoding).newDecoder().decode(ByteBuffer.wrap(line.getBytes()));
//        buffer = new UnicodeCharList(cb.length());
//        
//        UnicodeChar uc = UnicodeChar.NULL;
//        for (int i = 0; i < cb.length(); i += uc.getChar16Count()) {
//        	uc = new UnicodeChar(cb,i);
//        	buffer.add(uc);
//        }
//    }
//
...
//     
//    /**
//     * Returns the internal buffer as String.
