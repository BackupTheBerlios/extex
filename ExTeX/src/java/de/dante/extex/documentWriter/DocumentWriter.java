...
public interface DocumentWriter {
    /**
     * Getter for the extension associated with this kind of output. E.g. <tt>.pdf</tt>
     * is the expected value for PDF files and <tt>.dvi</tt> is the expected
     * value for DVI files.
     * 
     ...
     */
    public abstract void shipout(NodeList nodes);
