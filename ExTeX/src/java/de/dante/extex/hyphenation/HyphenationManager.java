 ...
 */
public class HyphenationManager extends AbstractFactory implements Serializable {
    ...
    public HyphenationTable getHyphenationTable(final String index)
        ...
        Object table = tables.get(index);
        if (table == null) {
            table = createInstance(index, HyphenationTable.class);
