 ...
 * {@link de.dante.extex.HyphenationManager HyphenationManager}.
 *
 *
 * <pre>
 ...
 */
public class HyphenationManagerFactory extends AbstractFactory {
     ...
     */
    public HyphenationManager newInstance(final String type)
            throws ConfigurationException {

        return (HyphenationManager) createInstance(type,
                HyphenationManager.class);
    }
