...
import de.dante.extex.interpreter.type.node.AbstractNode;
...
public class DeltaNode extends AbstractNode {
     ...
     * @param aDepth
     */
    public DeltaNode(Dimen aWidth, Dimen aHeight, Dimen aDepth) {

        super(aWidth, aHeight, aDepth);
    }

    /**
     * @see de.dante.extex.typesetter.Node#toString(java.lang.StringBuffer, java.lang.String)
     */
