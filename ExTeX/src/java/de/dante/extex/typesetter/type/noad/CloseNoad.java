 ...
 */
public class CloseNoad extends AbstractNucleusNoad implements SimpleNoad {
     ...
     */
    public CloseNoad(final Noad nucleus, final TypesettingContext tc) {

        super(nucleus, tc);
        setSpacingClass(MathSpacing.CLOSE);
    }
