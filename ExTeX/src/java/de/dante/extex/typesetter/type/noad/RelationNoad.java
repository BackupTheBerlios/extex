 ...
 */
public class RelationNoad extends AbstractNucleusNoad implements SimpleNoad {
     ...
     */
    public RelationNoad(final Noad nucleus, final TypesettingContext tc) {

        super(nucleus, tc);
        setSpacingClass(MathSpacing.REL);
    }
