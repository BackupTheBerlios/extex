 ...
 */
public class Logger14Impl implements Logger {
    /** the wrapped logger */
     ...
     */
    private Logger14Impl(final String name, final String resourceBundle) {
        super();
     ...
     * @param name the name
     */
    private Logger14Impl(final String name) {
        super();
    ...
    public synchronized static Logger getLogger(final String name,
        ...
        InputStream s = Logger14Impl.class.getClassLoader().getResourceAsStream(
            template);
