...
public interface Context extends Configurable, Serializable {
    ...
    /**
     * Setter for the interaction in the current group.
     * The interaction determines how verbose the actions are reported and
     * how the interaction with the user is performed in case of an error.
     *
     ...
     * A maximal value can be enforced by an implementation.
     *
     * @param mag the new magnification factor
     *
     * @throws GeneralHelpingException in case that the magnification factor
     * is not in the allowed range or that the magnification has been set to a
     * different value earlier.
     */
    public abstract void setMagnification(long mag)
                                   throws GeneralHelpingException;
     ...
     * The token factory can be used to get new tokens of some kind.
     *
