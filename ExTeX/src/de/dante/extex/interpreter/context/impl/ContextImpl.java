 ...
 *   higher groups; all or some of them to speed up the next access.
 *   This optimization is currently not implemented.
 *  </li>
 *  <li>
 *   If a local value has to be stored then it can be stored in the local group
 *   only.
 *  </li>
 *  <li>
 *   If a global value has to be stored then the group chain has to be
 *   traversed and the value has to be set in all approrpiate groups:
 *   There are several implementation variants
 *   <ul>
 *    <li> Clear the value in all groups and set it in the bottommost group.
 *    </li>
 *    <li> Set the value in all groups where it has a local value.
 *    </li>
 *    <li> Set teh value in all groups.
 *    </li>
 *   </ul>
 *   Here the third approach is used which is suspected to be a little more
 *   efficient on the cost of slightly more memory consumption.
 *  </li>
 * </ul>
 *
...
public class ContextImpl implements Context, Serializable {
    ...
    /** This is the entry to the linked list of groups.
    ...
    /**
     * @see de.dante.extex.interpreter.context.Context#setActive(java.lang.String, de.dante.extex.interpreter.Code)
     */
    ...
    /**
     * @see de.dante.extex.interpreter.context.Context#setCatcode(char, de.dante.extex.scanner.Catcode)
     */
    public void setCatcode(char c, Catcode cc)
    ...
    /**
     * @see de.dante.extex.interpreter.context.Context#setDimen(java.lang.String, long)
     */
    ...
    /**
     * @see de.dante.extex.interpreter.context.Context#setDimen(java.lang.String, de.dante.extex.interpreter.type.Dimen)
     */
    ...
    /**
     * @see de.dante.extex.interpreter.context.Context#setDimen(java.lang.String, de.dante.extex.interpreter.type.Dimen, boolean)
     */
    ...
    /**
     * @see de.dante.extex.interpreter.context.Context#setDimen(java.lang.String, long, boolean)
     */
    ...
    /**
     * @see de.dante.extex.interpreter.context.Context#setMacro(java.lang.String, de.dante.extex.interpreter.Code)
     */
    ...
    public void setMagnification(long mag)
        ...
        if (magnificationLock && this.magnification != mag) {
            throw new GeneralHelpingException("TTP.IncompatMag",
                                              Long.toString(mag));
        }
        ...
        try {
            maximalMagnification = config.getValueAsInteger("maximalMagnification",
                                                            32768);
        ...
        if (mag < 1 || mag > maximalMagnification) {
            throw new GeneralHelpingException("TTP.IllegalMag",
                                              Long.toString(mag));
        }
