...
/**
 * This class provides an implementation for the primitive <code>\countdef</code>.
 * 
 * <p>
 * Example
 * </p>
 ...
 */
public class CountDef extends AbstractCode {
	...
	public void execute(final Flags prefix, final Context context, final TokenSource source, Typesetter typesetter) throws GeneralException {
		...
		code = new DefinedCount(tok.getValue(),"count", value);
