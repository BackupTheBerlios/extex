...
/**
 * This class provides an implementation for a defined <code>\toks</code>-register
 * with <code>\toksdef</code>.
 * 
 * @author <a href="mailto:mgn@gmx.de">Michael Niedermair</a>
 * @version $Revision: 1.1 $
 */
public class DefinedToks extends NamedToks {
	 ...
	 */
	public DefinedToks(String name, String regname, long number) {
		super(name);
		this.number = number;
