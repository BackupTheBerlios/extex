...
import de.dante.extex.font.SVGException;
...
public class SVG2EFM {
	...
	public static void main(String[] args) throws SVGException, IOException, JDOMException {

		if (args.length != 3) {
			System.err.println("java de.dante.util.font.SVG2EFM <svg-file> <efm-file> <default-size>");
			System.exit(1);
		}
