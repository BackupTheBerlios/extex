...
<xsl:template match="testsuites">
    ...
    <style type="text/css">
      ...
      h1 {
        margin: 0px 0px 5px; font: 165% sans-serif
      }
      h2 {
        margin-top: 1em; margin-bottom: 0.5em; font: bold 125% sans-serif
      }
      h3 {
        margin-bottom: 0.5em; font: bold 115% sans-serif
      }
      h4 {
        margin-bottom: 0.5em; font: bold 100% sans-serif
      }
      h5 {
        margin-bottom: 0.5em; font: bold 100% sans-serif
      }
      ...
      <script type="text/javascript" language="JavaScript">
       ...
       <script type="text/javascript" language="JavaScript"><![CDATA[
        function displayProperties (name) {
          ...
          doc.write("<style>")
          doc.write("body {font:normal 68% sans-serif; color:#000000; }");
          doc.write("table tr td, table tr th { font-size: 68%; }");
          doc.write("table.properties { border-collapse:collapse; border-left:solid 1 #cccccc; border-top:solid 1 #cccccc; padding:5px; }");
          doc.write("table.properties th { text-align:left; border-right:solid 1 #cccccc; border-bottom:solid 1 #cccccc; background-color:#eeeeee; }");
          doc.write("table.properties td { font:normal; text-align:left; border-right:solid 1 #cccccc; border-bottom:solid 1 #cccccc; background-color:#fffffff; }");
          doc.write("h3 { margin-bottom: 0.5em; font: bold 115% sans-serif }");
          doc.write("</style>");
          doc.write("</head><body>");
